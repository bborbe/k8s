...
type K8sSecretInterface struct {
	...
	applyArgsForCall []struct {
		...
		arg2 *v1a.SecretApplyConfiguration
...
func (fake *K8sSecretInterface) Apply(arg1 context.Context, arg2 *v1a.SecretApplyConfiguration, arg3 v1b.ApplyOptions) (*v1.Secret, error) {
...
func (fake *K8sSecretInterface) ApplyCalls(stub func(context.Context, *v1a.SecretApplyConfiguration, v1b.ApplyOptions) (*v1.Secret, error)) {
	fake.applyMutex.Lock()
	defer fake.applyMutex.Unlock()
	fake.ApplyStub = stub
}

func (fake *K8sSecretInterface) ApplyArgsForCall(i int) (context.Context, *v1a.SecretApplyConfiguration, v1b.ApplyOptions) {
	fake.applyMutex.RLock()
	defer fake.applyMutex.RUnlock()
...
func (fake *K8sSecretInterface) Watch(arg1 context.Context, arg2 v1b.ListOptions) (watch.Interface, error) {
...
func (fake *K8sSecretInterface) recordInvocation(key string, args []interface{}) {
...
var _ k8s.SecretInterface = new(K8sSecretInterface)
