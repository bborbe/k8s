...
func (fake *K8sStatefulSetDeployer) Undeploy(arg1 context.Context, arg2 k8s.Namespace, arg3 string) error {
...
func (fake *K8sStatefulSetDeployer) UndeployCalls(stub func(context.Context, k8s.Namespace, string) error) {
	fake.undeployMutex.Lock()
	defer fake.undeployMutex.Unlock()
	fake.UndeployStub = stub
}

func (fake *K8sStatefulSetDeployer) UndeployArgsForCall(i int) (context.Context, k8s.Namespace, string) {
	fake.undeployMutex.RLock()
	defer fake.undeployMutex.RUnlock()
...
func (fake *K8sStatefulSetDeployer) recordInvocation(key string, args []interface{}) {
...
var _ k8s.StatefulSetDeployer = new(K8sStatefulSetDeployer)
