...
type K8sServiceInterface struct {
	...
	applyArgsForCall []struct {
		...
		arg2 *v1a.ServiceApplyConfiguration
...
func (fake *K8sServiceInterface) Apply(arg1 context.Context, arg2 *v1a.ServiceApplyConfiguration, arg3 v1b.ApplyOptions) (*v1.Service, error) {
...
func (fake *K8sServiceInterface) ApplyCalls(stub func(context.Context, *v1a.ServiceApplyConfiguration, v1b.ApplyOptions) (*v1.Service, error)) {
	fake.applyMutex.Lock()
	defer fake.applyMutex.Unlock()
	fake.ApplyStub = stub
}

func (fake *K8sServiceInterface) ApplyArgsForCall(i int) (context.Context, *v1a.ServiceApplyConfiguration, v1b.ApplyOptions) {
	fake.applyMutex.RLock()
	defer fake.applyMutex.RUnlock()
...
func (fake *K8sServiceInterface) ApplyStatus(arg1 context.Context, arg2 *v1a.ServiceApplyConfiguration, arg3 v1b.ApplyOptions) (*v1.Service, error) {
...
func (fake *K8sServiceInterface) List(arg1 context.Context, arg2 v1b.ListOptions) (*v1.ServiceList, error) {
	fake.listMutex.Lock()
...
func (fake *K8sServiceInterface) Watch(arg1 context.Context, arg2 v1b.ListOptions) (watch.Interface, error) {
...
func (fake *K8sServiceInterface) recordInvocation(key string, args []interface{}) {
...
var _ k8s.ServiceInterface = new(K8sServiceInterface)
