...
type K8sPodInterface struct {
	...
	applyArgsForCall []struct {
		...
		arg2 *v1a.PodApplyConfiguration
	...
	updateResizeMutex       sync.RWMutex
	updateResizeArgsForCall []struct {
		arg1 context.Context
		arg2 string
		arg3 *v1.Pod
		arg4 v1b.UpdateOptions
	}
	updateResizeReturns struct {
		result1 *v1.Pod
		result2 error
	}
	updateResizeReturnsOnCall map[int]struct {
		result1 *v1.Pod
		result2 error
	}
...
func (fake *K8sPodInterface) ApplyArgsForCall(i int) (context.Context, *v1a.PodApplyConfiguration, v1b.ApplyOptions) {
	fake.applyMutex.RLock()
	defer fake.applyMutex.RUnlock()
...
func (fake *K8sPodInterface) UpdateResize(arg1 context.Context, arg2 string, arg3 *v1.Pod, arg4 v1b.UpdateOptions) (*v1.Pod, error) {
	fake.updateResizeMutex.Lock()
	ret, specificReturn := fake.updateResizeReturnsOnCall[len(fake.updateResizeArgsForCall)]
	fake.updateResizeArgsForCall = append(fake.updateResizeArgsForCall, struct {
		arg1 context.Context
		arg2 string
		arg3 *v1.Pod
		arg4 v1b.UpdateOptions
	}{arg1, arg2, arg3, arg4})
	stub := fake.UpdateResizeStub
	fakeReturns := fake.updateResizeReturns
	fake.recordInvocation("UpdateResize", []interface{}{arg1, arg2, arg3, arg4})
	fake.updateResizeMutex.Unlock()
	if stub != nil {
		return stub(arg1, arg2, arg3, arg4)
	}
	if specificReturn {
...
func (fake *K8sPodInterface) UpdateResizeReturns(result1 *v1.Pod, result2 error) {
	fake.updateResizeMutex.Lock()
	defer fake.updateResizeMutex.Unlock()
	fake.UpdateResizeStub = nil
	fake.updateResizeReturns = struct {
		result1 *v1.Pod
		result2 error
	}{result1, result2}
}
...
func (fake *K8sPodInterface) UpdateResizeReturnsOnCall(i int, result1 *v1.Pod, result2 error) {
	...
	defer fake.updateResizeMutex.Unlock()
	fake.UpdateResizeStub = nil
	if fake.updateResizeReturnsOnCall == nil {
		fake.updateResizeReturnsOnCall = make(map[int]struct {
			result1 *v1.Pod
			result2 error
		})
	}
	fake.updateResizeReturnsOnCall[i] = struct {
		result1 *v1.Pod
		result2 error
	}{result1, result2}
}
...
func (fake *K8sPodInterface) recordInvocation(key string, args []interface{}) {
...
var _ k8s.PodInterface = new(K8sPodInterface)
