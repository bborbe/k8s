...
func (fake *K8sDeploymentDeployer) Undeploy(arg1 context.Context, arg2 k8s.Namespace, arg3 string) error {
...
func (fake *K8sDeploymentDeployer) UndeployCalls(stub func(context.Context, k8s.Namespace, string) error) {
	fake.undeployMutex.Lock()
	defer fake.undeployMutex.Unlock()
	fake.UndeployStub = stub
}

func (fake *K8sDeploymentDeployer) UndeployArgsForCall(i int) (context.Context, k8s.Namespace, string) {
	fake.undeployMutex.RLock()
	defer fake.undeployMutex.RUnlock()
...
func (fake *K8sDeploymentDeployer) recordInvocation(key string, args []interface{}) {
...
var _ k8s.DeploymentDeployer = new(K8sDeploymentDeployer)
