...
type K8sJobInterface struct {
	...
	applyArgsForCall []struct {
		...
		arg2 *v1a.JobApplyConfiguration
...
func (fake *K8sJobInterface) ApplyArgsForCall(i int) (context.Context, *v1a.JobApplyConfiguration, v1b.ApplyOptions) {
	fake.applyMutex.RLock()
	defer fake.applyMutex.RUnlock()
...
func (fake *K8sJobInterface) recordInvocation(key string, args []interface{}) {
...
var _ k8s.JobInterface = new(K8sJobInterface)
