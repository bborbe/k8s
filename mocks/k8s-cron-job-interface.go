...
import (
	...
	v1a "k8s.io/client-go/applyconfigurations/batch/v1"
)
...
type K8sCronJobInterface struct {
	...
	applyArgsForCall []struct {
		...
		arg2 *v1a.CronJobApplyConfiguration
...
func (fake *K8sCronJobInterface) Apply(arg1 context.Context, arg2 *v1a.CronJobApplyConfiguration, arg3 v1b.ApplyOptions) (*v1.CronJob, error) {
...
func (fake *K8sCronJobInterface) ApplyCalls(stub func(context.Context, *v1a.CronJobApplyConfiguration, v1b.ApplyOptions) (*v1.CronJob, error)) {
	fake.applyMutex.Lock()
	defer fake.applyMutex.Unlock()
	fake.ApplyStub = stub
}

func (fake *K8sCronJobInterface) ApplyArgsForCall(i int) (context.Context, *v1a.CronJobApplyConfiguration, v1b.ApplyOptions) {
	fake.applyMutex.RLock()
	defer fake.applyMutex.RUnlock()
...
func (fake *K8sCronJobInterface) ApplyStatus(arg1 context.Context, arg2 *v1a.CronJobApplyConfiguration, arg3 v1b.ApplyOptions) (*v1.CronJob, error) {
...
func (fake *K8sCronJobInterface) List(arg1 context.Context, arg2 v1b.ListOptions) (*v1.CronJobList, error) {
	fake.listMutex.Lock()
...
func (fake *K8sCronJobInterface) Watch(arg1 context.Context, arg2 v1b.ListOptions) (watch.Interface, error) {
...
func (fake *K8sCronJobInterface) recordInvocation(key string, args []interface{}) {
...
var _ k8s.CronJobInterface = new(K8sCronJobInterface)
