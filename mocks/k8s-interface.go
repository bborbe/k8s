...
import (
	...
	v1k "k8s.io/client-go/kubernetes/typed/flowcontrol/v1"
	...
	v1alpha1d "k8s.io/client-go/kubernetes/typed/lifecycle/v1alpha1"
	...
	v1alpha3a "k8s.io/client-go/kubernetes/typed/scheduling/v1alpha3"
	...
	v1s "k8s.io/client-go/kubernetes/typed/storagemigration/v1"
...
type K8sInterface struct {
	...
	coordinationV1alpha2Mutex       sync.RWMutex
	coordinationV1alpha2ArgsForCall []struct {
	}
	coordinationV1alpha2Returns struct {
		result1 v1alpha2.CoordinationV1alpha2Interface
	}
	coordinationV1alpha2ReturnsOnCall map[int]struct {
		result1 v1alpha2.CoordinationV1alpha2Interface
	}
	...
	flowcontrolV1Mutex       sync.RWMutex
	flowcontrolV1ArgsForCall []struct {
	}
	flowcontrolV1Returns struct {
		result1 v1k.FlowcontrolV1Interface
	}
	flowcontrolV1ReturnsOnCall map[int]struct {
		result1 v1k.FlowcontrolV1Interface
	}
	...
	LifecycleV1alpha1Stub        func() v1alpha1d.LifecycleV1alpha1Interface
	lifecycleV1alpha1Mutex       sync.RWMutex
	lifecycleV1alpha1ArgsForCall []struct {
	}
	lifecycleV1alpha1Returns struct {
		result1 v1alpha1d.LifecycleV1alpha1Interface
	}
	lifecycleV1alpha1ReturnsOnCall map[int]struct {
		result1 v1alpha1d.LifecycleV1alpha1Interface
	}
	...
	resourceV1alpha3ArgsForCall []struct {
	}
	resourceV1alpha3Returns struct {
		result1 v1alpha3.ResourceV1alpha3Interface
	}
	resourceV1alpha3ReturnsOnCall map[int]struct {
		result1 v1alpha3.ResourceV1alpha3Interface
	}
	ResourceV1beta1Stub        func() v1beta1o.ResourceV1beta1Interface
	resourceV1beta1Mutex       sync.RWMutex
	resourceV1beta1ArgsForCall []struct {
	}
	resourceV1beta1Returns struct {
	...
	SchedulingV1alpha3Stub        func() v1alpha3a.SchedulingV1alpha3Interface
	schedulingV1alpha3Mutex       sync.RWMutex
	schedulingV1alpha3ArgsForCall []struct {
	}
	schedulingV1alpha3Returns struct {
		result1 v1alpha3a.SchedulingV1alpha3Interface
	}
	schedulingV1alpha3ReturnsOnCall map[int]struct {
		result1 v1alpha3a.SchedulingV1alpha3Interface
	}
	...
	StoragemigrationV1Stub        func() v1s.StoragemigrationV1Interface
	storagemigrationV1Mutex       sync.RWMutex
	storagemigrationV1ArgsForCall []struct {
	}
	storagemigrationV1Returns struct {
		result1 v1s.StoragemigrationV1Interface
	}
	storagemigrationV1ReturnsOnCall map[int]struct {
		result1 v1s.StoragemigrationV1Interface
	}
...
func (fake *K8sInterface) CoordinationV1alpha2() v1alpha2.CoordinationV1alpha2Interface {
	fake.coordinationV1alpha2Mutex.Lock()
	ret, specificReturn := fake.coordinationV1alpha2ReturnsOnCall[len(fake.coordinationV1alpha2ArgsForCall)]
	fake.coordinationV1alpha2ArgsForCall = append(fake.coordinationV1alpha2ArgsForCall, struct {
	}{})
	stub := fake.CoordinationV1alpha2Stub
	fakeReturns := fake.coordinationV1alpha2Returns
	fake.recordInvocation("CoordinationV1alpha2", []interface{}{})
	fake.coordinationV1alpha2Mutex.Unlock()
	if stub != nil {
		return stub()
	}
	if specificReturn {
...
func (fake *K8sInterface) CoordinationV1alpha2CallCount() int {
	fake.coordinationV1alpha2Mutex.RLock()
	defer fake.coordinationV1alpha2Mutex.RUnlock()
	return len(fake.coordinationV1alpha2ArgsForCall)
}

func (fake *K8sInterface) CoordinationV1alpha2Calls(stub func() v1alpha2.CoordinationV1alpha2Interface) {
	fake.coordinationV1alpha2Mutex.Lock()
	defer fake.coordinationV1alpha2Mutex.Unlock()
	fake.CoordinationV1alpha2Stub = stub
}

func (fake *K8sInterface) CoordinationV1alpha2Returns(result1 v1alpha2.CoordinationV1alpha2Interface) {
	fake.coordinationV1alpha2Mutex.Lock()
	defer fake.coordinationV1alpha2Mutex.Unlock()
	fake.CoordinationV1alpha2Stub = nil
	fake.coordinationV1alpha2Returns = struct {
		result1 v1alpha2.CoordinationV1alpha2Interface
	}{result1}
}
...
func (fake *K8sInterface) CoordinationV1alpha2ReturnsOnCall(i int, result1 v1alpha2.CoordinationV1alpha2Interface) {
	...
	defer fake.coordinationV1alpha2Mutex.Unlock()
	fake.CoordinationV1alpha2Stub = nil
	if fake.coordinationV1alpha2ReturnsOnCall == nil {
		fake.coordinationV1alpha2ReturnsOnCall = make(map[int]struct {
			result1 v1alpha2.CoordinationV1alpha2Interface
		})
	}
	fake.coordinationV1alpha2ReturnsOnCall[i] = struct {
		result1 v1alpha2.CoordinationV1alpha2Interface
	}{result1}
}
...
func (fake *K8sInterface) Discovery() discovery.DiscoveryInterfaces {
...
func (fake *K8sInterface) DiscoveryCalls(stub func() discovery.DiscoveryInterfaces) {
	fake.discoveryMutex.Lock()
	defer fake.discoveryMutex.Unlock()
	fake.DiscoveryStub = stub
}

func (fake *K8sInterface) DiscoveryReturns(result1 discovery.DiscoveryInterfaces) {
	fake.discoveryMutex.Lock()
	defer fake.discoveryMutex.Unlock()
...
func (fake *K8sInterface) DiscoveryReturnsOnCall(i int, result1 discovery.DiscoveryInterfaces) {
	fake.discoveryMutex.Lock()
	defer fake.discoveryMutex.Unlock()
	fake.DiscoveryStub = nil
...
func (fake *K8sInterface) FlowcontrolV1() v1k.FlowcontrolV1Interface {
	fake.flowcontrolV1Mutex.Lock()
	ret, specificReturn := fake.flowcontrolV1ReturnsOnCall[len(fake.flowcontrolV1ArgsForCall)]
	fake.flowcontrolV1ArgsForCall = append(fake.flowcontrolV1ArgsForCall, struct {
	}{})
	stub := fake.FlowcontrolV1Stub
	fakeReturns := fake.flowcontrolV1Returns
	fake.recordInvocation("FlowcontrolV1", []interface{}{})
	fake.flowcontrolV1Mutex.Unlock()
	if stub != nil {
		return stub()
	}
	if specificReturn {
...
func (fake *K8sInterface) FlowcontrolV1CallCount() int {
	fake.flowcontrolV1Mutex.RLock()
	defer fake.flowcontrolV1Mutex.RUnlock()
	return len(fake.flowcontrolV1ArgsForCall)
}

func (fake *K8sInterface) FlowcontrolV1Calls(stub func() v1k.FlowcontrolV1Interface) {
	fake.flowcontrolV1Mutex.Lock()
	defer fake.flowcontrolV1Mutex.Unlock()
	fake.FlowcontrolV1Stub = stub
}

func (fake *K8sInterface) FlowcontrolV1Returns(result1 v1k.FlowcontrolV1Interface) {
	fake.flowcontrolV1Mutex.Lock()
	defer fake.flowcontrolV1Mutex.Unlock()
	fake.FlowcontrolV1Stub = nil
	fake.flowcontrolV1Returns = struct {
		result1 v1k.FlowcontrolV1Interface
	}{result1}
}
...
func (fake *K8sInterface) FlowcontrolV1ReturnsOnCall(i int, result1 v1k.FlowcontrolV1Interface) {
	...
	defer fake.flowcontrolV1Mutex.Unlock()
	fake.FlowcontrolV1Stub = nil
	if fake.flowcontrolV1ReturnsOnCall == nil {
		fake.flowcontrolV1ReturnsOnCall = make(map[int]struct {
			result1 v1k.FlowcontrolV1Interface
		})
	}
	fake.flowcontrolV1ReturnsOnCall[i] = struct {
		result1 v1k.FlowcontrolV1Interface
	}{result1}
}
...
func (fake *K8sInterface) LifecycleV1alpha1() v1alpha1d.LifecycleV1alpha1Interface {
	fake.lifecycleV1alpha1Mutex.Lock()
	ret, specificReturn := fake.lifecycleV1alpha1ReturnsOnCall[len(fake.lifecycleV1alpha1ArgsForCall)]
	fake.lifecycleV1alpha1ArgsForCall = append(fake.lifecycleV1alpha1ArgsForCall, struct {
	}{})
	stub := fake.LifecycleV1alpha1Stub
	fakeReturns := fake.lifecycleV1alpha1Returns
	fake.recordInvocation("LifecycleV1alpha1", []interface{}{})
	fake.lifecycleV1alpha1Mutex.Unlock()
	if stub != nil {
		return stub()
	}
	if specificReturn {
...
func (fake *K8sInterface) LifecycleV1alpha1CallCount() int {
	fake.lifecycleV1alpha1Mutex.RLock()
	defer fake.lifecycleV1alpha1Mutex.RUnlock()
	return len(fake.lifecycleV1alpha1ArgsForCall)
}

func (fake *K8sInterface) LifecycleV1alpha1Calls(stub func() v1alpha1d.LifecycleV1alpha1Interface) {
	fake.lifecycleV1alpha1Mutex.Lock()
	defer fake.lifecycleV1alpha1Mutex.Unlock()
	fake.LifecycleV1alpha1Stub = stub
}

func (fake *K8sInterface) LifecycleV1alpha1Returns(result1 v1alpha1d.LifecycleV1alpha1Interface) {
	fake.lifecycleV1alpha1Mutex.Lock()
	defer fake.lifecycleV1alpha1Mutex.Unlock()
	fake.LifecycleV1alpha1Stub = nil
	fake.lifecycleV1alpha1Returns = struct {
		result1 v1alpha1d.LifecycleV1alpha1Interface
	}{result1}
}

func (fake *K8sInterface) LifecycleV1alpha1ReturnsOnCall(i int, result1 v1alpha1d.LifecycleV1alpha1Interface) {
	fake.lifecycleV1alpha1Mutex.Lock()
	defer fake.lifecycleV1alpha1Mutex.Unlock()
	fake.LifecycleV1alpha1Stub = nil
	if fake.lifecycleV1alpha1ReturnsOnCall == nil {
		fake.lifecycleV1alpha1ReturnsOnCall = make(map[int]struct {
			result1 v1alpha1d.LifecycleV1alpha1Interface
		})
	}
	fake.lifecycleV1alpha1ReturnsOnCall[i] = struct {
		result1 v1alpha1d.LifecycleV1alpha1Interface
	}{result1}
}
...
func (fake *K8sInterface) ResourceV1alpha3() v1alpha3.ResourceV1alpha3Interface {
	fake.resourceV1alpha3Mutex.Lock()
	ret, specificReturn := fake.resourceV1alpha3ReturnsOnCall[len(fake.resourceV1alpha3ArgsForCall)]
	fake.resourceV1alpha3ArgsForCall = append(fake.resourceV1alpha3ArgsForCall, struct {
	}{})
	stub := fake.ResourceV1alpha3Stub
	fakeReturns := fake.resourceV1alpha3Returns
	fake.recordInvocation("ResourceV1alpha3", []interface{}{})
	fake.resourceV1alpha3Mutex.Unlock()
	if stub != nil {
		return stub()
	}
	if specificReturn {
...
func (fake *K8sInterface) ResourceV1alpha3ReturnsOnCall(i int, result1 v1alpha3.ResourceV1alpha3Interface) {
	...
	defer fake.resourceV1alpha3Mutex.Unlock()
	fake.ResourceV1alpha3Stub = nil
	if fake.resourceV1alpha3ReturnsOnCall == nil {
		fake.resourceV1alpha3ReturnsOnCall = make(map[int]struct {
			result1 v1alpha3.ResourceV1alpha3Interface
		})
	}
	fake.resourceV1alpha3ReturnsOnCall[i] = struct {
		result1 v1alpha3.ResourceV1alpha3Interface
	}{result1}
}

func (fake *K8sInterface) ResourceV1beta1() v1beta1o.ResourceV1beta1Interface {
	fake.resourceV1beta1Mutex.Lock()
	ret, specificReturn := fake.resourceV1beta1ReturnsOnCall[len(fake.resourceV1beta1ArgsForCall)]
	fake.resourceV1beta1ArgsForCall = append(fake.resourceV1beta1ArgsForCall, struct {
	}{})
	stub := fake.ResourceV1beta1Stub
	fakeReturns := fake.resourceV1beta1Returns
	fake.recordInvocation("ResourceV1beta1", []interface{}{})
	fake.resourceV1beta1Mutex.Unlock()
	if stub != nil {
		return stub()
	}
	if specificReturn {
...
func (fake *K8sInterface) ResourceV1beta1ReturnsOnCall(i int, result1 v1beta1o.ResourceV1beta1Interface) {
	...
	defer fake.resourceV1beta1Mutex.Unlock()
	fake.ResourceV1beta1Stub = nil
	if fake.resourceV1beta1ReturnsOnCall == nil {
		fake.resourceV1beta1ReturnsOnCall = make(map[int]struct {
			result1 v1beta1o.ResourceV1beta1Interface
		})
	}
	fake.resourceV1beta1ReturnsOnCall[i] = struct {
		result1 v1beta1o.ResourceV1beta1Interface
	}{result1}
}
...
func (fake *K8sInterface) SchedulingV1alpha3() v1alpha3a.SchedulingV1alpha3Interface {
	fake.schedulingV1alpha3Mutex.Lock()
	ret, specificReturn := fake.schedulingV1alpha3ReturnsOnCall[len(fake.schedulingV1alpha3ArgsForCall)]
	fake.schedulingV1alpha3ArgsForCall = append(fake.schedulingV1alpha3ArgsForCall, struct {
	}{})
	stub := fake.SchedulingV1alpha3Stub
	fakeReturns := fake.schedulingV1alpha3Returns
	fake.recordInvocation("SchedulingV1alpha3", []interface{}{})
	fake.schedulingV1alpha3Mutex.Unlock()
	if stub != nil {
		return stub()
	}
	if specificReturn {
...
func (fake *K8sInterface) SchedulingV1alpha3CallCount() int {
	fake.schedulingV1alpha3Mutex.RLock()
	defer fake.schedulingV1alpha3Mutex.RUnlock()
	return len(fake.schedulingV1alpha3ArgsForCall)
}

func (fake *K8sInterface) SchedulingV1alpha3Calls(stub func() v1alpha3a.SchedulingV1alpha3Interface) {
	fake.schedulingV1alpha3Mutex.Lock()
	defer fake.schedulingV1alpha3Mutex.Unlock()
	fake.SchedulingV1alpha3Stub = stub
}

func (fake *K8sInterface) SchedulingV1alpha3Returns(result1 v1alpha3a.SchedulingV1alpha3Interface) {
	fake.schedulingV1alpha3Mutex.Lock()
	defer fake.schedulingV1alpha3Mutex.Unlock()
	fake.SchedulingV1alpha3Stub = nil
	fake.schedulingV1alpha3Returns = struct {
		result1 v1alpha3a.SchedulingV1alpha3Interface
	}{result1}
}

func (fake *K8sInterface) SchedulingV1alpha3ReturnsOnCall(i int, result1 v1alpha3a.SchedulingV1alpha3Interface) {
	fake.schedulingV1alpha3Mutex.Lock()
	defer fake.schedulingV1alpha3Mutex.Unlock()
	fake.SchedulingV1alpha3Stub = nil
	if fake.schedulingV1alpha3ReturnsOnCall == nil {
		fake.schedulingV1alpha3ReturnsOnCall = make(map[int]struct {
			result1 v1alpha3a.SchedulingV1alpha3Interface
		})
	}
	fake.schedulingV1alpha3ReturnsOnCall[i] = struct {
		result1 v1alpha3a.SchedulingV1alpha3Interface
	}{result1}
}
...
func (fake *K8sInterface) StoragemigrationV1() v1s.StoragemigrationV1Interface {
	fake.storagemigrationV1Mutex.Lock()
	ret, specificReturn := fake.storagemigrationV1ReturnsOnCall[len(fake.storagemigrationV1ArgsForCall)]
	fake.storagemigrationV1ArgsForCall = append(fake.storagemigrationV1ArgsForCall, struct {
	}{})
	stub := fake.StoragemigrationV1Stub
	fakeReturns := fake.storagemigrationV1Returns
	fake.recordInvocation("StoragemigrationV1", []interface{}{})
	fake.storagemigrationV1Mutex.Unlock()
	if stub != nil {
		return stub()
	}
	if specificReturn {
...
func (fake *K8sInterface) StoragemigrationV1CallCount() int {
	fake.storagemigrationV1Mutex.RLock()
	defer fake.storagemigrationV1Mutex.RUnlock()
	return len(fake.storagemigrationV1ArgsForCall)
}

func (fake *K8sInterface) StoragemigrationV1Calls(stub func() v1s.StoragemigrationV1Interface) {
	fake.storagemigrationV1Mutex.Lock()
	defer fake.storagemigrationV1Mutex.Unlock()
	fake.StoragemigrationV1Stub = stub
}

func (fake *K8sInterface) StoragemigrationV1Returns(result1 v1s.StoragemigrationV1Interface) {
	fake.storagemigrationV1Mutex.Lock()
	defer fake.storagemigrationV1Mutex.Unlock()
	fake.StoragemigrationV1Stub = nil
	fake.storagemigrationV1Returns = struct {
		result1 v1s.StoragemigrationV1Interface
	}{result1}
}

func (fake *K8sInterface) StoragemigrationV1ReturnsOnCall(i int, result1 v1s.StoragemigrationV1Interface) {
	fake.storagemigrationV1Mutex.Lock()
	defer fake.storagemigrationV1Mutex.Unlock()
	fake.StoragemigrationV1Stub = nil
	if fake.storagemigrationV1ReturnsOnCall == nil {
		fake.storagemigrationV1ReturnsOnCall = make(map[int]struct {
			result1 v1s.StoragemigrationV1Interface
		})
	}
	fake.storagemigrationV1ReturnsOnCall[i] = struct {
		result1 v1s.StoragemigrationV1Interface
	}{result1}
}
...
func (fake *K8sInterface) recordInvocation(key string, args []interface{}) {
...
var _ k8s.Interface = new(K8sInterface)
